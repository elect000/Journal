...
\date{}
\title{実習１：中心極限定理と大数の法則}
\begin{document}

\maketitle
\tableofcontents

\section{課題１：中心極限定理、大数の弱法則}
\label{sec:org3285833}
\subsection{サイズnの標本を多数用意して、標本平均 \(\overline{X}\) がどのように分布するかを調べよう}
\label{sec:org465c05e}
\begin{figure}[htbp]
\centering
