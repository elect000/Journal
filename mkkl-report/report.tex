...
\label{sec:org68d950e}
先に紹介した2つに対してこちらは\\
\subsubsection{vector-z}
\label{sec:org8d6357a}

\subsubsection{clatrix}
\label{sec:org6861022}
\subsection{ACM3 (Apache Common Math 3)}
\label{sec:orge3e50bf}
\section{ARIMA モデルによる時系列分析}
\label{sec:org43d30a9}
\subsection{ARIMA モデルの概要}
\label{sec:org8afe3ac}
\subsection{BackShift記法}
\label{sec:orgd7f67cf}
\subsection{単位根検定}
\label{sec:org90f655e}
\subsubsection{ADF検定}
\label{sec:orgd6bc55b}
\subsubsection{KPSS検定}
\label{sec:orgf5e93c2}
\subsection{AR モデル}
\label{sec:org114d23d}
\subsection{MA モデル}
\label{sec:org0b52eec}
\subsection{係数推定}
\label{sec:orga75fe6b}
\subsubsection{対数尤度}
\label{sec:orgf0b33a0}
\subsubsection{AIC}
\label{sec:org764c5ef}
\subsubsection{最小二乗法}
\label{sec:orge51fa26}
\subsubsection{アメーバ法}
\label{sec:orgc2fbc5e}
\subsection{SARIMA モデルについて}
\label{sec:orgcc2d090}
\section{Clojure/ClojureScript を用いた Web 開発}
\label{sec:org76f55a1}
\subsection{Clojure によるバックエンド開発}
\label{sec:orge859632}
\subsubsection{Luminus Framework}
\label{sec:org47b81fa}
\subsubsection{Swagger UI}
\label{sec:org2b01b91}
\subsection{ClojureScript によるフロントエンド開発}
\label{sec:org3d59591}
\subsubsection{基本的な開発}
\label{sec:org1ea85f2}
\subsubsection{Reagent}
\label{sec:orgbb9b86e}
\subsubsection{core.async による非同期処理}
\label{sec:org38d0f1d}
\section{MKKL の開発}
\label{sec:org06199fe}
\section{発展 : ARIMA 推定 と Random Forest による予測}
\label{sec:org7964e05}
\subsection{概要}
\label{sec:org09d5730}
\subsection{実験方法}
\label{sec:org36d3285}
\subsection{実験結果}
\label{sec:orgde5c776}
\subsection{考察}
\label{sec:orgddf1693}
\section{まとめと今後の課題}
\label{sec:org45f9caf}
